...
| Module | Description |
|--------|-------------|
| [Inserir no Banco de Dados](#inserir-no-banco-de-dados) | Inserir dados em tabelas de banco de dados |
| [Consulta de Banco de Dados](#consulta-de-banco-de-dados) | Executar consultas SQL em bancos de dados PostgreSQL, MySQL ou SQLite |
| [Atualizar Banco de Dados](#atualizar-banco-de-dados) | Atualizar dados em tabelas de banco de dados |
| [MongoDB Find](#mongodb-find) | Consultar documentos de colecao MongoDB |
| [MongoDB Insert](#mongodb-insert) | Inserir um ou mais documentos em colecao MongoDB |
| [Consulta MySQL](#consulta-mysql) | Executar consulta SQL no banco de dados MySQL e retornar resultados |
| [Consulta PostgreSQL](#consulta-postgresql) | Executar consulta SQL no banco de dados PostgreSQL e retornar resultados |
| [Redis Get](#redis-get) | Obter valor do cache Redis |
| [Redis Set](#redis-set) | Definir valor no cache Redis |
...
Inserir dados em tabelas de banco de dados
...
|-------|------|-------------|
| `inserted_count` | number | Numero de linhas inseridas |
| `returning_data` | array | Numero de linhas inseridas |
...
Executar consultas SQL em bancos de dados PostgreSQL, MySQL ou SQLite
...
| Field | Type | Description |
|-------|------|-------------|
| `rows` | array | Linhas do resultado da consulta |
| `row_count` | number | Linhas do resultado da consulta |
| `columns` | array | Linhas do resultado da consulta |
...
Atualizar dados em tabelas de banco de dados
...
| Field | Type | Description |
|-------|------|-------------|
| `updated_count` | number | Numero de linhas atualizadas |
...
Consultar documentos de colecao MongoDB
...
| Field | Type | Description |
|-------|------|-------------|
| `documents` | array | Array de documentos correspondentes |
| `count` | number | Array de documentos correspondentes |
...
Inserir um ou mais documentos em colecao MongoDB
...
| Field | Type | Description |
|-------|------|-------------|
| `inserted_count` | number | Numero de documentos inseridos |
| `inserted_ids` | array | Numero de documentos inseridos |
...
Executar consulta SQL no banco de dados MySQL e retornar resultados
...
| Field | Type | Description |
|-------|------|-------------|
| `rows` | array | Array de linhas de resultado como objetos |
| `row_count` | number | Array de linhas de resultado como objetos |
| `columns` | array | Array de linhas de resultado como objetos |
...
Executar consulta SQL no banco de dados PostgreSQL e retornar resultados
...
| Field | Type | Description |
|-------|------|-------------|
| `value` | any | O valor retornado |
| `exists` | boolean | O valor retornado |
| `key` | string | O valor retornado |
