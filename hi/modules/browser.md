...
| Module | Description |
|--------|-------------|
| [चुनौती संभालें](#चुनौती-संभालें) | एंटी-बॉट चुनौतियों का स्वचालित पहचान और प्रबंधन (Cloudflare, CAPTCHA) |
...
| [रिमोट कनेक्ट](#रिमोट-कनेक्ट) | रिमोट ब्राउज़र सेवा से कनेक्ट करें (Browserless, BrowserBase)। असली fingerprint, Cloudflare बायपास। |
...
| [कुकी फ़ाइल](#कुकी-फ़ाइल) | ब्राउज़र कुकीज़ को JSON फ़ाइल से/में आयात या निर्यात करें। |
...
| [सूची पहचानें](#सूची-पहचानें) | पेज पर दोहराई जाने वाली आइटम का स्वचालित पहचान (लेख, उत्पाद, खोज परिणाम) |
...
| [नेस्टेड निकालें](#नेस्टेड-निकालें) | ट्री/नेस्टेड डेटा निकालें (टिप्पणियाँ, थ्रेड, फ़ोल्डर)। |
...
| [ब्राउज़र इंटरैक्ट](#ब्राउज़र-इंटरैक्ट) | उपयोगकर्ता को ब्राउज़र पेज के साथ इंटरैक्ट करने के लिए रोकें |
| [ब्राउज़र लॉन्च करें](#ब्राउज़र-लॉन्च-करें) | Playwright के साथ नया ब्राउज़र इंस्टेंस लॉन्च करें |
| [लॉगिन](#लॉगिन) | लॉगिन फ़ॉर्म का स्वचालित पहचान और भरना, लॉगिन-बाद सत्यापन सहित। |
...
| [ब्राउज़र पूल](#ब्राउज़र-पूल) | समानांतर स्वचालन के लिए कई ब्राउज़र इंस्टेंस प्रबंधित करें। |
| [कुंजी दबाएं](#कुंजी-दबाएं) | कीबोर्ड कुंजी दबाएं |
| [प्रॉक्सी रोटेट](#प्रॉक्सी-रोटेट) | निष्क्रिय प्रॉक्सी पहचान के साथ प्रॉक्सी सूची को रोटेट करें। |
| [लेख निकालें](#लेख-निकालें) | स्मार्ट लेख निष्कर्षण — किसी भी वेबपेज से शीर्षक, लेखक, तिथि और मुख्य सामग्री निकालें |
...
| [प्रतिक्रिया कैप्चर](#प्रतिक्रिया-कैप्चर) | API प्रतिक्रिया बॉडी कैप्चर करें (XHR/fetch)। पेज API कॉल से JSON निकालें। |
| [Robots.txt जाँचें](#robots.txt-जाँचें) | robots.txt अनुपालन जाँचें और sitemap खोजें। |
...
| [Sitemap पार्स](#sitemap-पार्स) | sitemap.xml पार्स करें और metadata सहित URL निकालें। |
...
| [तालिका निकालें](#तालिका-निकालें) | HTML तालिकाओं को स्वचालित पहचाने गए हेडर के साथ संरचित डेटा में निकालें। |
| [दर सीमक](#दर-सीमक) | प्रति-डोमेन दर सीमा। ब्लॉक होने से बचने के लिए अनुरोधों के बीच प्रतीक्षा। |
...
एंटी-बॉट चुनौतियों का स्वचालित पहचान और प्रबंधन (Cloudflare, CAPTCHA)
...
रिमोट ब्राउज़र सेवा से कनेक्ट करें (Browserless, BrowserBase)। असली fingerprint, Cloudflare बायपास।
...
ब्राउज़र कुकीज़ को JSON फ़ाइल से/में आयात या निर्यात करें।
...
पेज पर दोहराई जाने वाली आइटम का स्वचालित पहचान (लेख, उत्पाद, खोज परिणाम)
...
ट्री/नेस्टेड डेटा निकालें (टिप्पणियाँ, थ्रेड, फ़ोल्डर)।
...
उपयोगकर्ता को ब्राउज़र पेज के साथ इंटरैक्ट करने के लिए रोकें
...
| `action` | string | निष्पादित कार्रवाई (click/select/type/toggle) |
| `selector` | string | इंटरैक्ट किए गए तत्व का CSS selector |
| `value` | string | उपयोग किया गया मान (select/type क्रियाओं के लिए) |
| `url` | string | इंटरैक्शन के समय पेज URL |
...
लॉगिन फ़ॉर्म का स्वचालित पहचान और भरना, लॉगिन-बाद सत्यापन सहित।
...
समानांतर स्वचालन के लिए कई ब्राउज़र इंस्टेंस प्रबंधित करें।
...
निष्क्रिय प्रॉक्सी पहचान के साथ प्रॉक्सी सूची को रोटेट करें।
...
स्मार्ट लेख निष्कर्षण — किसी भी वेबपेज से शीर्षक, लेखक, तिथि और मुख्य सामग्री निकालें
...
| `selector` | string | No | - | सामग्री क्षेत्र के लिए CSS selector। स्वचालित पहचान के लिए खाली छोड़ें। |
...
API प्रतिक्रिया बॉडी कैप्चर करें (XHR/fetch)। पेज API कॉल से JSON निकालें।
...
robots.txt अनुपालन जाँचें और sitemap खोजें।
...
sitemap.xml पार्स करें और metadata सहित URL निकालें।
...
HTML तालिकाओं को स्वचालित पहचाने गए हेडर के साथ संरचित डेटा में निकालें।
...
प्रति-डोमेन दर सीमा। ब्लॉक होने से बचने के लिए अनुरोधों के बीच प्रतीक्षा।
