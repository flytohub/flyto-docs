...
| `llm_provider` | select (`openai`, `anthropic`, `gemini`, `ollama`) | No | `openai` | अधिकतम तर्क चरण |
...
| `model` | string | No | `claude-sonnet-4-6` | उपयोग करने के लिए Claude मॉडल |
...
| `model` | string | No | `gemini-2.5-pro` | उपयोग करने के लिए Gemini मॉडल |
...
| `model` | select (`gpt-4o`, `gpt-4o-mini`, `gpt-4.1`, `gpt-4.1-mini`, `o3`, `o3-mini`, `o4-mini`, `gpt-4-turbo-preview`) | No | `gpt-4o` | GPT को भेजने के लिए संदेश |
| `temperature` | number | No | `0.7` | सैंपलिंग तापमान (0-2) |
