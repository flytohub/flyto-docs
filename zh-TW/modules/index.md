...
|----------|---------|-------------|
| [No-Code Browser Automation](/zh-TW/modules/browser) | 54 | Use open-source no-code browser automation modules for navigation, forms, extraction, screenshots, Web Vitals, evidence, and replay. |
...
| [MCP](/zh-TW/modules/mcp) | 1 | Model Context Protocol helpers for recipe and tool execution. |

### Data

| Category | Modules | Description |
|----------|---------|-------------|
| [Data Transform](/zh-TW/modules/data-transform) | 18 | CSV, JSON, XML, YAML parsing, generation, and pipeline transformations. |
...
| [API Tools](/zh-TW/modules/api-tools) | 10 | GitHub API, HTTP requests, and search engine integrations. |
...
| [Communication](/zh-TW/modules/communication) | 4 | Team communication helpers for Slack, webhooks, and outbound messages. |
...
| [Verification](/zh-TW/modules/verification) | 4 | Deterministic verification primitives for discovery, scenario generation, run evidence, and reports. |
| [Warroom](/zh-TW/modules/warroom) | 6 | Compatibility modules for Warroom deterministic verification workflows. |
...
| [Training](/zh-TW/modules/training) | 4 | Training data, fine-tuning, and evaluation helpers. |
...
| [Meta](/zh-TW/modules/meta) | 4 | Module generation, listing, testing, and documentation. |
