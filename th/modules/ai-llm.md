...
| `llm_provider` | select (`openai`, `anthropic`, `gemini`, `ollama`) | No | `openai` | ขั้นตอนการใช้เหตุผลสูงสุด |
...
| `model` | string | No | `claude-sonnet-4-6` | โมเดล Claude ที่จะใช้ |
...
| `model` | string | No | `gemini-2.5-pro` | โมเดล Gemini ที่จะใช้ |
...
| `model` | select (`gpt-4o`, `gpt-4o-mini`, `gpt-4.1`, `gpt-4.1-mini`, `o3`, `o3-mini`, `o4-mini`, `gpt-4-turbo-preview`) | No | `gpt-4o` | ข้อความที่จะส่งไปยัง GPT |
| `temperature` | number | No | `0.7` | Temperature ในการสุ่ม (0-2) |
